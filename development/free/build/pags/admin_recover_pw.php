<div class="ad-main" id="adm-open">
    ...
    <div class="admin">
        ...
        <div class="pw-change">
            ...
            <h5 class="text-primary text-center">RECOVER PASSWORD</h5>

            <form method="POST" action="">

                <div class="form-group">
                    <select name="subject" class="form-control form-control-sm">
                        <option value="recover password">Recover Password</option>
                        <option value="server side">Bug Server</option>
                        <option value="cliente side">Bug Client</option>
                        <option value="website">Bug Website</option>
                        <option value="others">Others</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="target_nick">Your Login</label>
                    <input type="text" class="form-control" name="nick" id="target_nick" maxlength="16" autocomplete="off">
                </div>

            ...
            <div class="pw-change">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        <label for="target_email">Login</label>
                        <input type="text" class="form-control" name="login" id="target_login" maxlength="50" autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="hidden" name="token_user_recaptacha" id="token_recaptacha_id_change_password" value="">
                    <input type="hidden" name="form_change_password" value="true">
                    <input type="submit" class="btn w-100 btn-dark" value="Change">

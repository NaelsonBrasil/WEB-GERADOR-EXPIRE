...
<div class="register">
    ...
    <form method="POST" action="">
        ...
        <label class="sr-only" for="targetEmail">Email</label>
        <div class="input-group mb-2">
            <div class="input-group-prepend">
                <div class="input-group-text">Max 50</div>
            </div>
            <input type="email" class="form-control" name="email" id="targetEmail" maxlength="50" placeholder="email">
        </div>
